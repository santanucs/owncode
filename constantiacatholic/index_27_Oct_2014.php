...
<style>
        ...
        div#nyroModalLoading {
            ...
            background: #fff url('http://constantiacatholic.co.za/images/ajaxLoader.gif') no-repeat;
...
<td align="left" valign="top">
														...
														<?php if ($this->countModules ('collage' )) :?>
                                                                ...
                                                                <jdoc:include type="modules" name="collage" style="none" />
...
Click on a date to see details for that day.</td>
       ...
       <?php if ($this->countModules (('parish_notices' )) || ($this->countModules ('appeals' )) || ($this->countModules ('classified_ads' )) || ($this->countModules ('week_photo' ))) :?>
...
<tr>
																...
																<?php if ($this->countModules ('classified_ads' )) :?>



                                                                    <jdoc:include type="modules" name="classified_ads" style="none" />
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <table style="width: 100%;" border="0" cellpadding ="0" cellspacing ="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" style="padding-left:0px; padding-top:0px;" colspan="2">



					
<iframe src="templates/constantiacatholic/twitter.php" height="238" width="700"></iframe> 	
...
if($Itemid!='237' && $articleId!='342' && $articleId!='344' && $articleId!='343' && $articleId!='345' )
{
?><?php */?>
                                       <tr>
...
<?php /*?>   <?php
$articleId = $_REQUEST['id'];
if($articleId!='342' && $articleId!='344')
{
?><?php */?>
                                                ...
                                                <tr><td colspan="2" align="left" valign="top"><?php if ($this->countModules ('slider_inner' )) :?>



                                                        <jdoc:include type="modules" name="slider_inner" style="none" />
