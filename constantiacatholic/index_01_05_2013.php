...
<style>
        ...
        jQuery(function() {
            ...
            jQuery.nyroModalSettings({height: , width: });
                                                    ...
                                                    <td align="right" valign="top" style="padding-top:12px;">
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" border="0">
                                                            ...
                                                            <!--
                                                                ...
                                                                <input name="searchword" alt="Search" style="border:2px solid #b3b3b3; height:22px; padding: 0px 0px 0px 0px; width:145px;" type="text" size= "20" value="" />
                                                                ...
                                                                <input type="image" value=""  style="border:0px #0000FF solid; padding: 0px 0px 0px 0px;" src="templates/constantiacatholic/images/searchbutton.gif"/>
                                              ...
                                              <tr>
                                                ...
                                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td valign="top" align="center" width="33%" class="YouthBlock">

                                                    <span>Notices</span><br /><br />

                                                    <a href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis laoreet fringilla eros sed varius.</a><br /><br />
                                                    ...
                                                    <a href="#"><img src="templates/constantiacatholic/images/more-white.png" alt="More" title="More" /></a>

                                                    </td>

                                                    <td valign="top" align="center" width="34%" class="YouthBlock">
                                        ...
                                        <td align="left" valign="top">
                                            ...
                                            <table style="width: 100%;" border="0" cellpadding ="0" cellspacing ="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top" style="padding-left:10px; padding-top:12px;">
